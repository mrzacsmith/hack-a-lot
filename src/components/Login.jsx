      ...
      <div className="max-w-md w-full">
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <input
                ...
                name="remember-me"
                type="checkbox"
                className="h-4 w-4 text-sisu-blue focus:ring-sisu-blue border-gray-300 rounded"
              />
            ...
            <div className="text-sm">
              <Link to="/reset-password" className="font-medium text-sisu-blue hover:text-sisu-blue-dark">
          ...
          <div className="text-sm text-center">
            <Link to="/register" className="font-medium text-sisu-blue hover:text-sisu-blue-dark">
